...
<!-- 
HOW THIS WORKS
This is step 2B of "home" (See login.jsp for description of entire home folder)
...
<body>
		<!-----------------------------------------------------------------------------------------------
			            QUERY DATABASE TO SEE IF NEW USER IS VALID, THEN INSERT
		------------------------------------------------------------------------------------------------>
	...
	try {
		...
		//Select Database to Use "BuyMyFurniture"
		...
		if( newUsername.equals("") || newPassword.equals("") || newEmail.equals("") ||
				newFirstName.equals("") || newLastName.equals("")){
			%> 
			<script> 
		...
		// 3. QUERY DATABASE to see if username has been taken
		...
		// 4. QUERY DATABASE to see if email has been taken
		...
		//IF ALL PASSES: INSERT user into the database table "Users"
		...
		ps.executeUpdate();
		con.close();
		//SET USER SESSION >> "user_username" will return the user's username
		session.setAttribute("user_username", newUsername);
