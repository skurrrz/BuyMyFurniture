...
<body>
		...
		------------------------------------------------------------------------------------------------>		
		<%	
		int delete_auctionID = Integer.parseInt(request.getParameter("delete_auctionID"));
		%>
		...
		try {
			...
			Statement stmt = con.createStatement();
				...
				String deleteAnswer = "DELETE FROM Auctions WHERE auctionID LIKE '" + delete_auctionID + "';";
				...
				%>		
				<script> 
				    alert("Success! The auction has been deleted. Returning to Forum Home.");
