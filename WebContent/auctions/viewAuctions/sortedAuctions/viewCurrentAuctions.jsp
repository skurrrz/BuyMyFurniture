...
<body>
		...
		try {
			...
			String query= "SELECT * FROM Auctions a LEFT JOIN Items i ON a.auctionID = i.auctionID"
					+ " LEFT JOIN (SELECT auctionID, MAX(bid_amount) AS topBid, AutoUpperLimit AS"
					+ " topBidAutoLimit, bidder AS topBidder, COUNT(bid_amount) AS numBids FROM Bids"
					+ " GROUP BY auctionID) t1 ON a.auctionID = t1.auctionID WHERE a.isActive LIKE"
					+ " '1' ORDER BY a.auctionID ASC;";
