...
<body>
	...
	String newLightType = request.getParameter("lamp_light_type");
	String newNumBulbs = request.getParameter("lamp_num_bulbs");
	...
	try {
		...
		Statement stmt = con.createStatement();
			...
			String addWishlist = "INSERT INTO Wishlist(wishID, username, item_category, date_added, item_type,"
								+ " item_manufacturer, item_condition, item_color, item_material, lamp_light_type, lamp_num_bulbs)"
								+ " VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
				...
				ps.setString(10, newLightType);
				ps.setString(11, newNumBulbs);
				ps.executeUpdate();
				con.close();
