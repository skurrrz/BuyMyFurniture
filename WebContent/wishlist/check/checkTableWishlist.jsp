...
<body>
	...
	String newtableShape = request.getParameter("table_shape");
	String newtableNumLegs = request.getParameter("table_num_legs");
	...
	try {
		...
		Statement stmt = con.createStatement();
			...
			String addWishlist = "INSERT INTO Wishlist(wishID, username, item_category, date_added, item_type,"
								+ " item_manufacturer, item_condition, item_color, item_material, table_shape, table_num_legs)"
								+ " VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
				...
				ps.setString(10, newtableShape);
				ps.setString(11, newtableNumLegs);
				ps.executeUpdate();
				con.close();
