...
<body>
		...
		------------------------------------------------------------------------------------------------>		
		<%	
		int delete_QuestionID = Integer.parseInt(request.getParameter("delete_QuestionID"));
		%>
		...
		try {
			...
			Statement stmt = con.createStatement();
				...
				String deleteQuestion = "DELETE FROM Questions WHERE questionID LIKE '" + delete_QuestionID + "';";
				PreparedStatement ps = con.prepareStatement(deleteQuestion);
				ps.executeUpdate();
				con.close();

				%>		
				<script> 
				    alert("Success! The question has been deleted. Returning to Forum Home.");
