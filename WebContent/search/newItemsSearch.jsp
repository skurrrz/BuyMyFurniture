...
<%@ page import="javax.servlet.http.*,javax.servlet.*"%>
 ...
 <!---------------------------------- HOW THIS WORKS -------------------------------------
Step 2 of Item Search (see search/searchForItems.jsp for full details)
...
<!-----------------------------------------------------------------------------------------------
			        IF THE USER IS LOOKING FOR ANY CATEGOR
------------------------------------------------------------------------------------------------>	
		...
		<div class="searchItems">
			<div class="form">
	   			<form class="allItemsSearch" method="post" action="check/checkAllSearch.jsp">
		    	<h1> Item Search </h1>
		    	<br>
		    	<hr>
		    	<p class="message">Search for Keywords that may be included in the title:</p>
					<input type="text" min="1" maxlength="50" placeholder="" name="keyword1"/>
					<input type="text" min="1" maxlength="50" placeholder="" name="keyword2"/>
					<input type="text" min="1" maxlength="50" placeholder="" name="keyword3"/>
...
------------------------------------------------------------------------------------------------>	
		...
		<div class="searchItems">
	  		<div class="form">
				<form class="chairSearch" method="post" action="check/checkChairSearch.jsp">
			    	<h1> Chair Search </h1>
			    	<br>
			    	<hr>
			    	<p class="message">Search for Keywords that may be included in the title:</p>
...
------------------------------------------------------------------------------------------------>	
		...
		<div class="searchItems">
			<div class="form">
			    <form class="tableSearch" method="post" action="check/checkTableSearch.jsp">
			    	<h1> Table Search </h1>
			    	<br>
			    	<hr>
			    	<p class="message">Search for Keywords that may be included in the title:</p>
...
------------------------------------------------------------------------------------------------>			
		...
		<div class="searchItems">
	  		<div class="form">
			  	  <form class="lampSearch" method="post" action="check/checkLampSearch.jsp">
			    	<h1> Lamp Search </h1>
			    	<br>
			    	<hr>
			    	<p class="message">Search for Keywords that may be included in the title:</p>
