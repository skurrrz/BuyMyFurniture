...
<!-- 
Step 3C of Item Search (see search/searchForItems.jsp for full details)
...
<body>
	...
	String queryItemLightType = "";
	String queryItemNumBulbs = "";
	...
	if (!newItemLightType.equals("Any")) {
		queryItemLightType = " AND i.lamp_light_type LIKE '" + newItemLightType + "'";
	} 
	
	if (!newItemNumBulbs.equals("Any")) {
		queryItemNumBulbs = " AND i.lamp_num_bulbs LIKE '" + newItemNumBulbs + "'";
	} 
	...
	try {
		...
		Statement stmt = con.createStatement();
			...
			String searchForItem = "SELECT * FROM Auctions a LEFT JOIN Items i ON a.auctionID = i.auctionID"
									+ " WHERE a.isActive LIKE '1' AND a.item_category LIKE 'lamp' AND a.title LIKE '%" + newKeyWord1 + "%'"
									...
									+ queryItemMaterial + queryItemLightType + queryItemNumBulbs
